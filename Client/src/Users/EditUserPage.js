...
class EditUserComp extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      isEdited: true,
      fname: this.props.location.state.FirstName,
      lname: this.props.location.state.LastName,
      username: this.props.location.state.UserName,
      session: this.props.location.state.SessionTimeOut,
      permissions: [
        {
  ...
  updateUser = async (e) => {
    ...
    let obj = {
      ...
      SessionTimeOut: this.state.session,
      Permissions: checkedPers,
      Role : this.props.location.state.Role
    };
    const resp = await utils.updateUser(this.props.location.state._id,obj);
    debugger;
    if (resp.status === 200) {
    ...
    return (
      <form className={classes.form} onSubmit={e => this.updateUser(e)}>
        ...
        <TextField
          ...
          id="created"
          required
          value={this.props.location.state.CreatedDate}
          disabled
        />
